      ...
      <div className="mx-auto max-w-5xl px-4 py-16">
        ...
        <div className="mt-16 rounded-xl border bg-blue-50 p-6">
          ...
          <p className="mt-2 text-sm text-blue-800">
            This app exposes 15 WebMCP tools. Use the built-in &ldquo;Ask the Agent&rdquo; chat, or open
            ...
            draft a step-by-step contribution plan, visualize matches, and track contributions for you.
          </p>
        </div>
      </div>
    </main>
