      ...
      <div className="mx-auto max-w-5xl px-4 py-16">
        ...
        <div className="mt-16 rounded-xl border bg-blue-50 p-6">
          ...
          <p className="mt-2 text-sm text-blue-800">
            This app exposes 19 WebMCP tools. Use the built-in &ldquo;Ask the Agent&rdquo; chat, or open
            the app in a WebMCP-enabled browser, and an AI agent can search projects, gauge how
            responsive they are, find issues, assess their difficulty, check if they&rsquo;re available,
            draft a step-by-step contribution plan, remember your skills, recommend projects,
            summarize your progress, visualize matches, and track contributions for you.
          </p>
        </div>
      </div>
    </main>
